...
def get_value_comparasion(name):
    ...
    if(return_value[0][0] == None):
        return_value[0][0]=""
    elif(return_value[1][0]== None):
        return_value[1][0]=""
    return return_value
    ...
    for name in root.findall('instruction'):
        ...
        if (name.get('opcode').upper() == "JUMPIFEQS" or name.get('opcode').upper() == "JUMPIFNEQS"):
            ...
            if (values[0][1] == values[1][1] or (values[0][0] == "nil" or values[1][0] == "nil")):
                old_instruction=instruction_number
                try:
                ...
                if (values[0][0] != values[1][0] and name.get('opcode').upper() == "JUMPIFNEQS"):
                    ...
                    instruction_number=old_instruction
            else:
                sys.exit(53)
            ...
            if(name.find('arg1').attrib['type']=="var"):
                if (name.find('arg1').text[:2] == "GF"):
                    if (name.find('arg1').text[3:] in Global_frame):
                        ...
                        sys.exit(54)
                    if (Global_frame[name.find('arg1').text[3:]] == ""):
                        sys.exit(56)
                    if(Global_frame[name.find('arg1').text[3:]][1]== "nil" or Global_frame[name.find('arg1').text[3:]][0]== None):
                        print("", end='')
                    else:
                    ...
                    if (name.find('arg1').text[3:] in value):
                        ...
                        sys.exit(54)
                    if (value[name.find('arg1').text[3:]] == ""):
                        sys.exit(56)
                    if(value[name.find('arg1').text[3:]][1]== "nil" or value[name.find('arg1').text[3:]][0]== None):
                        print("", end='')
                    else:
                    ...
                    if (name.find('arg1').text[3:] in Temporary_frame):
                        ...
                        sys.exit(54)
                    if (Temporary_frame[name.find('arg1').text[3:]] == ""):
                        sys.exit(56)
                    if(Temporary_frame[name.find('arg1').text[3:]][1]== "nil" or Temporary_frame[name.find('arg1').text[3:]][0]== None):
                        print("", end='')
                    else:
